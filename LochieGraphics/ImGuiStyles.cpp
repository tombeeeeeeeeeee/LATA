...
void ImGuiStyles::SetLocStyle()
{
	...
	colors[ImGuiCol_Tab] = ImVec4(0.01f, 0.06f, 0.01f, 0.86f);
	colors[ImGuiCol_TabHovered] = ImVec4(0.02f, 0.14f, 0.04f, 0.80f);
	colors[ImGuiCol_TabActive] = ImVec4(0.10f, 0.37f, 0.16f, 0.80f);
	colors[ImGuiCol_TabUnfocused] = ImVec4(0.01f, 0.06f, 0.01f, 0.86f);
	colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.02f, 0.15f, 0.04f, 0.80f);
