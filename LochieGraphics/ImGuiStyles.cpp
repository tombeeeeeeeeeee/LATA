...
void ImGuiStyles::TemplateStyle()
{
...
void ImGuiStyles::SetLocStyle()
{
	...
	colors[ImGuiCol_FrameBg] = ImVec4(0.60f, 0.76f, 0.68f, 0.54f);
	...
	colors[ImGuiCol_CheckMark] = ImVec4(0.12f, 1.00f, 0.16f, 1.00f);
	colors[ImGuiCol_SliderGrab] = ImVec4(0.24f, 0.73f, 0.55f, 1.00f);
