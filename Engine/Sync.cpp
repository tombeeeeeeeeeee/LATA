...
)
{
	...
	if (inputDevice.getRightTrigger())
	{
		...
		lines->DrawCircle(glm::vec3(pos2D.x, 0.3f, pos2D.y), 100.0f * glm::clamp(0.0f, chargedDuration / sniperChargeTime, 1.0f), LineRenderer::Plane::XZ, { sniperBeamColour.x, sniperBeamColour.y, sniperBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.3f, pos2D.y), 100.5f * glm::clamp(0.0f, chargedDuration / sniperChargeTime, 1.0f), LineRenderer::Plane::XZ, { sniperBeamColour.x, sniperBeamColour.y, sniperBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.3f, pos2D.y), 101.5f * glm::clamp(0.0f, chargedDuration / sniperChargeTime, 1.0f), LineRenderer::Plane::XZ, { sniperBeamColour.x, sniperBeamColour.y, sniperBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.3f, pos2D.y), 101.5f * glm::clamp(0.0f, chargedDuration / sniperChargeTime, 1.0f), LineRenderer::Plane::XZ, { sniperBeamColour.x, sniperBeamColour.y, sniperBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.3f, pos2D.y), 102.0f * glm::clamp(0.0f, chargedDuration / sniperChargeTime, 1.0f), LineRenderer::Plane::XZ, { sniperBeamColour.x, sniperBeamColour.y, sniperBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.3f, pos2D.y), 102.5f * glm::clamp(0.0f, chargedDuration / sniperChargeTime, 1.0f), LineRenderer::Plane::XZ, { sniperBeamColour.x, sniperBeamColour.y, sniperBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.3f, pos2D.y), 103.0f * glm::clamp(0.0f, chargedDuration / sniperChargeTime, 1.0f), LineRenderer::Plane::XZ, { sniperBeamColour.x, sniperBeamColour.y, sniperBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.3f, pos2D.y), 103.5f * glm::clamp(0.0f, chargedDuration / sniperChargeTime, 1.0f), LineRenderer::Plane::XZ, { sniperBeamColour.x, sniperBeamColour.y, sniperBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.3f, pos2D.y), 104.0f * glm::clamp(0.0f, chargedDuration / sniperChargeTime, 1.0f), LineRenderer::Plane::XZ, { sniperBeamColour.x, sniperBeamColour.y, sniperBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.3f, pos2D.y), 104.5f * glm::clamp(0.0f, chargedDuration / sniperChargeTime, 1.0f), LineRenderer::Plane::XZ, { sniperBeamColour.x, sniperBeamColour.y, sniperBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.4f, pos2D.y), 100.0f * glm::clamp(0.0f, (chargedDuration - sniperChargeTime) / (overclockChargeTime - sniperChargeTime), 1.0f), LineRenderer::Plane::XZ, { overclockBeamColour.x, overclockBeamColour.y, overclockBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.4f, pos2D.y), 100.5f * glm::clamp(0.0f, (chargedDuration - sniperChargeTime) / (overclockChargeTime - sniperChargeTime), 1.0f), LineRenderer::Plane::XZ, { overclockBeamColour.x, overclockBeamColour.y, overclockBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.4f, pos2D.y), 101.0f * glm::clamp(0.0f, (chargedDuration - sniperChargeTime) / (overclockChargeTime - sniperChargeTime), 1.0f), LineRenderer::Plane::XZ, { overclockBeamColour.x, overclockBeamColour.y, overclockBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.4f, pos2D.y), 101.5f * glm::clamp(0.0f, (chargedDuration - sniperChargeTime) / (overclockChargeTime - sniperChargeTime), 1.0f), LineRenderer::Plane::XZ, { overclockBeamColour.x, overclockBeamColour.y, overclockBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.4f, pos2D.y), 102.0f * glm::clamp(0.0f, (chargedDuration - sniperChargeTime) / (overclockChargeTime - sniperChargeTime), 1.0f), LineRenderer::Plane::XZ, { overclockBeamColour.x, overclockBeamColour.y, overclockBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.4f, pos2D.y), 102.5f * glm::clamp(0.0f, (chargedDuration - sniperChargeTime) / (overclockChargeTime - sniperChargeTime), 1.0f), LineRenderer::Plane::XZ, { overclockBeamColour.x, overclockBeamColour.y, overclockBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.4f, pos2D.y), 103.0f * glm::clamp(0.0f, (chargedDuration - sniperChargeTime) / (overclockChargeTime - sniperChargeTime), 1.0f), LineRenderer::Plane::XZ, { overclockBeamColour.x, overclockBeamColour.y, overclockBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.4f, pos2D.y), 103.5f * glm::clamp(0.0f, (chargedDuration - sniperChargeTime) / (overclockChargeTime - sniperChargeTime), 1.0f), LineRenderer::Plane::XZ, { overclockBeamColour.x, overclockBeamColour.y, overclockBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.4f, pos2D.y), 104.0f * glm::clamp(0.0f, (chargedDuration - sniperChargeTime) / (overclockChargeTime - sniperChargeTime), 1.0f), LineRenderer::Plane::XZ, { overclockBeamColour.x, overclockBeamColour.y, overclockBeamColour.z });
		lines->DrawCircle(glm::vec3(pos2D.x, 0.4f, pos2D.y), 104.5f * glm::clamp(0.0f, (chargedDuration - sniperChargeTime) / (overclockChargeTime - sniperChargeTime), 1.0f), LineRenderer::Plane::XZ, { overclockBeamColour.x, overclockBeamColour.y, overclockBeamColour.z });
